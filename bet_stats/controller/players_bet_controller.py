...
@app.route('/players_bet', methods=['GET'])
def get_player_bets():
    ...
    players_bet_update.bet_match.choices = players_bet_create.bet_match.choices
    players_bet_update.player.choices = players_bet_create.player.choices
    return render_template('players_bet.html',
                           player_bets=[i.serialize for i in players_bet_service.get_all()],
